...
public class mebel2 {
    public static void main(String[] args) throws IOException {
        ...
        String Path = "http://mebelgrad.com/catalog/matrasy/";
...
//                String Size = doc3.getElementsByClass("product-otherprop-row").select("div[id=PROP_SIZE]").text();
                String Size = doc3.getElementsByClass("product-otherprop").select("div[id=PROP_SIZES_WxH]").text();
...
//                cell222.setCellValue(MainPrice2);
                ...
                cell223.setCellValue(Description + Description2);


                Cell cell224 = row.createCell(5);
                cell224.setCellValue( Description3 +Description4+ Description5);
